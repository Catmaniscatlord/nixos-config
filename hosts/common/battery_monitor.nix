...
# Stolen code
# https://github.com/Julow/env/blob/master/nixos/battery_monitor.nix
...
let
  cfg = config.hosts.common.battery_monitor;

in
{
  options.hosts.common.battery_monitor = with lib; {
    enable = mkEnableOption "Battery Monitor";
  };
